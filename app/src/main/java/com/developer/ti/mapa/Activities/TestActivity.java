    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_intent:
                ...
                IntentPickerSheetView intentPickerSheetView = new IntentPickerSheetView(TestActivity.this, shareIntent, "Share", new IntentPickerSheetView.OnIntentPickedListener() {
                    @Override
